...
const [selectedProgramer, setSelectedProgramer] = useState(null)
  ...
  return programmers.find(pr => pr.id == selectedProgramer).name
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: selectedProgramer ? 'gold': 'royalblue', // 🤔 color turns to gold, when celebrating
  };
